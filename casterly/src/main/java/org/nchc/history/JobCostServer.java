...
//                  Long su = historyFileParser.getSU(Long.parseLong(this.prop.getProperty("CPC", "1")));
     ...
     *                         jobFileStatusses.
     * @param batchSize        process up to length items (or less as to not exceed the length of
     *                         jobFileStatusses
     * @throws java.io.IOException when the index file cannot be written or moved, or when the HBase
