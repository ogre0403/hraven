...
public class GetGroupRequest {
    ...
    private String APP_UNIX_GROUP_UUID;

    public GetGroupRequest(String PRIVILEGED_APP_SSO_TOKEN,
                          String APP_UNIX_GROUP_UUID){
        this.PRIVILEGED_APP_SSO_TOKEN = PRIVILEGED_APP_SSO_TOKEN;
        this.APP_UNIX_GROUP_UUID = APP_UNIX_GROUP_UUID;
    }
    ...
    public String getAPP_UNIX_GROUP_UUID() {
        return APP_UNIX_GROUP_UUID;
    }
}
